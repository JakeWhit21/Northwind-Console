...
{
    public partial class NWConsole_23_JDWContext : DbContext
    {
        public NWConsole_23_JDWContext()
        {
        }

        public NWConsole_23_JDWContext(DbContextOptions<NWConsole_23_JDWContext> options)
            : base(options)
        {
        }
